        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0px solid #36ab80","cursor":"pointer","padding":"0 12px 0 6px","margin":"0 10px 5px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#769589","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
