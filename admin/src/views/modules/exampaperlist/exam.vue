<template>
	<div class="container">
		<div class="top-content">
			...
			<div class="right-content">
				<el-button type="danger" round @click="leaveTap">结束健康测评</el-button>
			</div>
		</div>
		<el-card class="card_view" v-if="isEndFlag">
			...
			<div class="item-content" style="color:#888888;text-align: center;">
				...
				<el-button @click="finishTap" type="primary">结束健康测评</el-button>
			</div>
		</el-card>
...
<script>
	export default {
		...
		methods: {
			leaveTap() {
				this.$confirm(`确定离开健康测评?未答题目按0分计算`, "提示", {
