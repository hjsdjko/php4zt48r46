<template>
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="选择健康测评" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择健康测评">
          <el-option
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="测评试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"padding":"0","margin":"30px 0","alignItems":"center","textAlign":"center","display":"flex","width":"100%","perspective":"320px","-webkitPerspective":"320px","fontSize":"48px","justifyContent":"flex-start"}'>
		<el-button class="btn3" :style='{"border":"0px solid rgba(126, 96, 16, .2)","cursor":"pointer","padding":"0 30px","margin":"0px 20px 0 0","color":"#fff","minWidth":"120px","outline":"none","borderRadius":"0px","background":"#374f45","width":"auto","fontSize":"16px","lineHeight":"24px","height":"40px"}' type="success" @click="onSubmit">
			<span class="icon iconfont icon-tijiao16" :style='{"margin":"0 2px","fontSize":"18px","color":"inherit","display":"none"}'></span>
			提交
		</el-button>
		<el-button class="btn4" :style='{"border":"0px solid rgba(126, 96, 16, .2)","cursor":"pointer","padding":"0 30px","margin":"0px 20px 0 0","color":"#fff","minWidth":"120px","outline":"none","borderRadius":"0px","background":"#374f45","width":"auto","fontSize":"16px","lineHeight":"24px","height":"40px"}' type="success" @click="back()">
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择健康测评", trigger: "blur" }],
        questionname: [
          { required: true, message: "测评试题内容不能为空", trigger: "blur" }
        ],
        type: [{ required: true, message: "请选择测评试题类型", trigger: "blur" }],
