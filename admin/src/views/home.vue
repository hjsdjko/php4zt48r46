...
<div class="content" :style='{"padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230929/d6f302810f564c39a7299342bf91b11b.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"100%"}'>
	...
	<!-- statis -->
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 0px 20px 0px","alignItems":"center","color":"#374f45","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 9px rgba(0,0,0,.3)","padding":"8px 20px","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","display":"flex","justifyContent":"space-around","borderRadius":"8px","background":"#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('yonghu','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji5" :style='{"color":"#374f45","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"row-reverse","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"5px 10px 0 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 9px rgba(0,0,0,.3)","padding":"8px 20px","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","display":"flex","justifyContent":"space-around","borderRadius":"8px","background":"#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('shangpinxinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji5" :style='{"color":"#374f45","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"row-reverse","justifyContent":"center","display":"flex"}'>
				...
				<div :style='{"margin":"5px 10px 0 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>商品信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- 日历 -->
	<div class="calendar" :style='{"border":"0px solid #eee","boxShadow":"0 0px 9px rgba(0,0,0,.3)","margin":"0px auto 20px","borderRadius":"8px","color":"#666","background":"none","width":"calc(100% - 0px)","fontSize":"inherit","height":"auto","order":"1"}'>
	  <div :style='{"padding":"10px 10px","borderColor":"rgba(126, 96, 16, .1)","color":"#fff","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"#769589","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-around","height":"auto"}'>
	  ...
	  <table :style='{"border":"0px solid #eee","width":"100%","padding":"0 0 20px","borderRadius":"0 0 8px 8px","background":"rgba(255, 255, 255, .96)","height":"auto"}' v-if="this.weeks.length">
	    <thead :style='{"width":"100%","height":"auto"}'>
	      <tr :style='{"width":"100%","alignItems":"center","justifyContent":"center","display":"flex"}'>
	        <th :style='{"alignItems":"center","color":"inherit","flex":1,"display":"flex","lineHeight":"54px","fontSize":"inherit","justifyContent":"center"}' v-for="item,index in this.heads" :key="index">{{item}}</th>
	      </tr>
	    </thead>
