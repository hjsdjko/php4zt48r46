<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","textAlign":"center","background":"none","display":"block","width":"auto","position":"","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"16px","color":"#fff","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
		<!-- 天气 -->
		<div class="weather" :style='{"padding":"0 0px","alignItems":"center","justifyContent":"center","display":"none","order":"2"}'>
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"fixed","right":"50px","color":"inherit","display":"inline-block","zIndex":"9999"}'>
		  <div class="el-dropdown-link" :style='{"alignItems":"center","display":"flex"}'>
		    <el-image v-if="user" :style='{"margin":"0 10px","objectFit":"cover","borderRadius":"100%","background":"url(http://codegen.caihongy.cn/20230929/21b4d006654c4188b33e2052816aaa3a.png) no-repeat center top / 100% 100%","display":"inline-block","width":"32px","height":"32px"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
